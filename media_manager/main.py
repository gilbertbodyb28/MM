...
import media_manager.seerr.router as seerr_router
import media_manager.settings.router as settings_router
import media_manager.torrent.router as torrent_router
import media_manager.trakt.router as trakt_router
...
api_app.include_router(
    release_calendar_router.router,
    prefix="/calendar",
    tags=["calendar"],
)
api_app.include_router(trakt_router.router, prefix="/trakt", tags=["trakt"])
api_app.include_router(seerr_router.router, prefix="/seerr", tags=["seerr"])
api_app.include_router(
